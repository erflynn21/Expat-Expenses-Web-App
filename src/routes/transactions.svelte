              ...
              <span class="flex flex-col text-gray-500 text-sm truncate">
                ...
                <span
                  ><span class="text-gray-900 font-medium"
                    >{$baseCurrencySymbol}{item.amount}</span
                  >
                </span>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead>
            <tr>
              ...
              <th
                class="hidden pr-2 py-3 bg-gray-50 text-right text-xs font-medium text-gray-500 uppercase tracking-wider md:block"
              >
                Category
              </th>
              <th
                class="pl-6 py-3 bg-gray-50 text-right text-xs font-medium text-gray-500 uppercase tracking-wider"
              >
                Date
              </th>
              <th
