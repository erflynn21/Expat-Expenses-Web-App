...
-->
  <div class="h-screen flex overflow-hidden bg-gray-100">
    ...
    -->
      <div
        class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-green-700"
      >
        <!--
        ...
        >
          <div class="px-2 space-y-1">
            ...
            >
              ...
              <svg
                class="mr-4 h-6 w-6 text-green-200"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
            ...
            <a
              href="/"
              class="text-green-100 hover:text-white hover:bg-green-600 group flex items-center px-2 py-2 text-base font-medium rounded-md"
            >
          ...
          <div class="mt-6 pt-6">
            <div class="px-2 space-y-1">
              <a
                href="/"
                class="group flex items-center px-2 py-2 text-base font-medium rounded-md text-green-100 hover:text-white hover:bg-green-600"
              >
    ...
    <div class="hidden lg:flex lg:flex-shrink-0">
      <div class="flex flex-col w-64">
        ...
        <div
          class="flex flex-col flex-grow bg-green-700 pt-5 pb-4 overflow-y-auto"
        >
          ...
          >
            <div class="px-2 space-y-1">
              ...
              <a
                href="/budget"
                class="text-green-100 hover:text-white hover:bg-green-600 group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md"
              >
                <svg
                  class="mr-4 text-green-200 w-6 h-6"
                  fill="none"
            ...
            <div class="mt-6 pt-6">
              <div class="px-2 space-y-1">
                <a
                  href="/settings"
                  class="group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md text-green-100 hover:text-white hover:bg-green-600"
                >
                  <svg
                    class="mr-4 h-6 w-6 text-green-200"
                    xmlns="http://www.w3.org/2000/svg"
