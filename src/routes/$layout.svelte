  ...
  <div class="fixed inset-0 flex z-40 lg:hidden" role="dialog" aria-modal="true">
    ...
    <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-green-700">
      ...
      <div class="flex-shrink-0 flex items-center px-4">
        <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/easywire-logo-green-300-mark-white-text.svg" alt="Easywire logo">
      </div>
      <nav class="mt-5 flex-shrink-0 h-full divide-y divide-green-800 overflow-y-auto" aria-label="Sidebar">
        <div class="px-2 space-y-1">
          <!-- Current: "bg-green-800 text-white", Default: "text-green-100 hover:text-white hover:bg-green-600" -->
          <a href="/" class="bg-green-800 text-white group flex items-center px-2 py-2 text-base font-medium rounded-md" aria-current="page">
          ...
          <a href="/" class="text-green-100 hover:text-white hover:bg-green-600 group flex items-center px-2 py-2 text-base font-medium rounded-md">
        ...
        <div class="mt-6 pt-6">
          <div class="px-2 space-y-1">
            <a href="/" class="group flex items-center px-2 py-2 text-base font-medium rounded-md text-green-100 hover:text-white hover:bg-green-600">
    ...
    <div class="flex flex-col w-64">
      ...
      <div class="flex flex-col flex-grow bg-green-700 pt-5 pb-4 overflow-y-auto">
        <div class="flex items-center flex-shrink-0 px-4">
          <img class="h-8 w-auto" src="icon.webp" alt="Expat Expenses Logo">
		  <span>Expat Expenses</span>
        </div>
        <nav class="mt-5 flex-1 flex flex-col divide-y divide-green-800 overflow-y-auto" aria-label="Sidebar">
          <div class="px-2 space-y-1">
            ...
            <a href="/" class="bg-green-800 text-white group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md" aria-current="page">
              <svg class="mr-4 text-green-200 w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/budget" class="text-green-100 hover:text-white hover:bg-green-600 group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md">
              <svg class="mr-4 text-green-200 w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/transactions" class="text-green-100 hover:text-white hover:bg-green-600 group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md">
              	<svg class='mr-4 text-green-200 w-6 h-6' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div class="mt-6 pt-6">
            <div class="px-2 space-y-1">
              <a href="/settings" class="group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md text-green-100 hover:text-white hover:bg-green-600">
                <svg class="mr-4 h-6 w-6 text-green-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
        ...
        <div class="px-4 sm:px-6 lg:max-w-6xl lg:mx-auto lg:px-8">
          <div class="py-6 md:flex md:items-center md:justify-between lg:border-t lg:border-gray-200">
			...
			<div class="ml-3 relative">
				<div>
					<button type="button" class="max-w-xs bg-white rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 lg:p-2 lg:rounded-md lg:hover:bg-gray-50" id="user-menu" aria-expanded="false" aria-haspopup="true" on:click={() => profileDropdownOpen = !profileDropdownOpen}>
